...
;var customer = [
		...
		//Скопировать себе в script.js data.json, сделать из него обычный javascript-массив (распарсить).
...
// First item
var firstItem = _.sortBy(_.uniq(_.flattenDepth(_.map(customer, 'skills'), 1)));
console.log(firstItem);

//Second item
var secondItem = _.map(_.sortBy(customer, ['friends.length', 'name']), 'name');
